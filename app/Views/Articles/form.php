<div class="article-form d-flex flex-column align-items-start gap-3 mx-auto pb-5 w-75">
...
<select name="category_id" id="category_id" class="form-control form-select">
    <option selected  <?php if($article->category_id): ?>value="<?= esc($current_category->category_id)?>"<?php else: ?> disabled <?php endif; ?>><?php if($article->category_id): ?> <?= esc($current_category->name)?><?php else: ?>Choose a Category <?php endif; ?></option>
